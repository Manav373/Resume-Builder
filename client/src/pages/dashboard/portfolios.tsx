...
export default function PortfoliosPage() {
    return (
        <div className="p-4 md:p-8 max-w-7xl mx-auto flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4 animate-in fade-in zoom-in-95 duration-500">
            ...
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight animate-in slide-in-from-bottom-2 duration-700 delay-300 fill-mode-both">Portfolios Coming Soon</h1>
